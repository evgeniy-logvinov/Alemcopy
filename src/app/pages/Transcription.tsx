...
export function Transcription() {
  ...
  const handleSubmit = () => {
    if (!transcription.trim()) {
      toast.error("Пожалуйста, введите транскрипцию перед отправкой");
      return;
    }
    ...
    toast.success("✅ Транскрипция отправлена! Ожидается проверка", {
      duration: 3000,
    });
    ...
    if (needsManualReview) {
      ...
      setTimeout(() => {
        ...
        if (isApproved) {
          ...
          toast.error(
            "❌ Транскрипция отклонена. Пожалуйста, просмотрите и отправьте заново.",
            {
              duration: 4000,
            }
          );
        ...
        <div className="mx-6 mt-6 bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[14px] text-red-700 mb-2">
              Ваша предыдущая транскрипция не была одобрена. Пожалуйста, ознакомьтесь с отзывом и исправьте текст.
            </p>
          ...
          {isEditing ? (
            <div className="space-y-3">
              <textarea
                ...
                placeholder="Введите текст транскрипции здесь..."
